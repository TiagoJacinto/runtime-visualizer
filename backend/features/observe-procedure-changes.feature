...
Feature: Observe source changes
  ...
  Domain definitions: [Source file](../CONTEXT.md#source-file), [Source revision](../CONTEXT.md#source-revision), [File change](../CONTEXT.md#file-change)
  Actor: Operator
  Platform: Runtime Visualizer workspace
