import { WorkspaceEventSchema } from "../../../../packages/contracts/src/index.ts";
import type { WorkspaceEvent } from "../../../../packages/contracts/src/index.ts";
...
export interface EventSubscription {
  readonly replay: readonly Record[];
...
export class WorkspaceEventHub {
  ...
  publish(event: WorkspaceEvent): number {
    ...
    const record = { event: valid, id: this.nextId };
    this.nextId += 1;
  ...
  subscribe(lastEventId?: number, listener?: Listener): EventSubscription {
