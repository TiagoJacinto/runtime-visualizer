...
export const WorkspaceManagementPlacementPrototype = () => {
  ...
  return (
    ...
    >
      {/* oxlint-disable-next-line eslint/no-use-before-define -- static CSS is declared below. */}
      <style>{css}</style>
