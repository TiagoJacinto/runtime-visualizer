...
export const ContextRail = ({
  ...
  const handleSelectFile = (file: string) => controller.selectFile(file);
  const handleSelectProcedure = (procedureId: string) =>
    controller.selectProcedure(procedureId);
  const handleSelectRevision = (scope: RevisionKey) =>
    controller.selectRevision(scope);
  const handleRunProcedure = () => controller.runProcedure();
  const handleSelectExecution = (executionId: string) =>
    controller.selectExecution(executionId);
  const handleClearCompleted = () => controller.clearCompleted();
  return (
    <aside
            ...
            <ActiveRuns
              ...
              onCancel={(executionId) => {
                if (state.cancellation.armedExecutionId === executionId) {
                  ...
                  controller.armCancel(executionId);
                }
              }}
