...
export const ActiveExecutionsResponseSchema = z.object({
  executions: z.array(ActiveExecutionSchema),
});
...
export const WorkspaceEventSchema = z.discriminatedUnion("type", [
  ...
  z.object({
    type: z.literal("revision-build-failed"),
    paths: z.array(z.string()),
    error: z.string(),
  }),
  z.object({
    type: z.literal("active-executions"),
    executions: z.array(ActiveExecutionSchema),
  }),
  z.object({
    type: z.literal("execution-update"),
    update: ExecutionUpdateSchema,
  }),
  z.object({ type: z.literal("resync-required") }),
]);
export type ActiveExecutionsResponse = z.infer<
  typeof ActiveExecutionsResponseSchema
>;
