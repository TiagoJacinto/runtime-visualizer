...
Sends a bounded request to the selected agent.

## Interface

The module exports `promptWorkflow`, a typed `WorkflowDefinition` consumed by the change-delivery registry. The request is supplied through the Factory workflow execution request.
