...
1. **Read all @-mentioned files immediately and FULLY**:
   ...
   - Problem files (e.g., `.rpi/problems/<problem slug>/problem.md`)
...
Populate **Findings** with only the facts from lightweight research that are relevant to the query plan. Cite every factual claim immediately with an exact repository `path:line` reference or a full primary-source URL. Prefer one claim per bullet. Search-result summaries are discovery aids, not sources.
...
1. **Write the research questions** to `.rpi/problems/TASKNAME/NN-research-questions-DESCRIPTION.md`
   - First, check if a related task directory exists: `ls -La .rpi/problems | grep -i "eng-XXXX"`
   ...
   - Directory naming:
     - With ticket: `.rpi/problems/ENG-1478-parent-child-tracking/01-research-questions-parent-child-tracking.md`
     - Without ticket: `.rpi/problems/authentication-flow/01-research-questions-auth-flow.md`
